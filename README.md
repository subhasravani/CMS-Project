...
3.sql-storage-solution.png shows tables and one query of data
...
4. storage-container.png is a screenshot showing container is created
...
5. blob-solution.png is a screenshot showing an  blob endpoints for where images are sent for storage.
...
7. log-solution.png is a screenshot showing one potential form of logging with an "Invalid login attempt" and "admin logged in successfully", taken from the app's Log stream.
